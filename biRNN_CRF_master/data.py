...
import biRNN_CRF_master.casphandle as casphandle
import biRNN_CRF_master.utils as utils

TRAIN_PATH = 'biRNN_CRF_master/data/cullpdb+profile_6133_filtered.npy.gz'
TEST_PATH = 'biRNN_CRF_master/data/cb513+profile_split1.npy.gz'
##### TRAIN DATA #####
